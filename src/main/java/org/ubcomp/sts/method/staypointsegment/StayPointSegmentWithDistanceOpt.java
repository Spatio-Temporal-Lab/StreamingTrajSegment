...
public class StayPointSegmentWithDistanceOpt extends AbstractStayPointSegment {
    private final List<Double> distances;

    public StayPointSegmentWithDistanceOpt(PointList pointList, List<Double> distances, double maxD, long minT) {
